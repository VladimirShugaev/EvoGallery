...
* Modified 
* 	beta 2 by Marc (mbe_v@hotmail.com) 
*		- add parameters : thumbPrefix, imagePrefix, snippetPath
*--------------------------------------------------------------------------*/
//
// System settings
//
...
$params['thumbsPath'] = isset($thumbsPath) ? $thumbsPath :  'thumbs/';
	// Path to the thumbs directory

$params['thumbPrefix'] = isset($thumbPrefix) ? $thumbPrefix :  '';
	// Prefix for generated thumbnail name - Default: ''

$params['imagePrefix'] = isset($imagePrefix) ? $imagePrefix :  '';
